...
| Добавление пункта в чек-лист | ✅ Всегда | ✅ Если назначен | ✅ Telegram |
| Изменение статуса пункта чек-листа | ✅ Всегда | ✅ Если назначен | ✅ Telegram |
| Проверка пункта хирургом | ✅ Всегда | ✅ Всегда | ✅ Telegram |
